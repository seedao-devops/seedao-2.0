  ...
  return (
    <div className="px-5 pt-3 pb-10 space-y-6">
      ...
      <header className="space-y-3">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
            <h1>{base.name}</h1>
            <p className="text-body text-muted-foreground flex items-center gap-1">
      ...
      <Section title="在地生活">
        <div className="grid gap-3">
          {base.localLife.accommodations.length ? (
            <Card className="p-4">
              <p className="text-caption font-medium text-muted-foreground mb-2">住宿</p>
          ...
          {base.localLife.coworking.length ? (
            <Card className="p-4">
              <p className="text-caption font-medium text-muted-foreground mb-2">共享工位</p>
          ...
          {base.localLife.tourism.length ? (
            <Card className="p-4">
              <p className="text-caption font-medium text-muted-foreground mb-2">周边</p>
      ...
      {(base.skillsOffered.length || base.skillsNeeded.length) ? (
        <Section title="技能交换">
          <Card className="p-4 space-y-3 text-body">
            {base.skillsOffered.length ? (
              <div className="space-y-1.5">
                <p className="text-caption text-muted-foreground">可提供</p>
                <div className="flex flex-wrap gap-1.5">
            ...
            {base.skillsNeeded.length ? (
              <div className="space-y-1.5">
                <p className="text-caption text-muted-foreground">需要</p>
                <div className="flex flex-wrap gap-1.5">
            ...
            {base.timeline.map((t) => (
              <li key={t.id} className="space-y-0.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-caption text-muted-foreground">{t.date}</span>
                </div>
